    ...
    <ModuleTransition delay="0.08">
      <section v-show="recoShowModule">
        <div class="page-title">
          ...
          <!-- <div v-show="$route.meta.words" class="word-box">
            <p v-if="$route.meta.words">{{ $route.meta.words }}</p>
            <p v-if="$route.meta.author">———— {{ $route.meta.author }}</p>
          </div> -->
        </div>
...
<script>
  import { defineComponent, computed, toRefs, ref, onMounted, watch } from 'vue-demi';
  // import PageInfo from '@theme/components/PageInfo';
  import { resolvePage, outboundRE, endingSlashRE } from '@theme/helpers/utils';
  import { ModuleTransition } from '@vuepress-reco/core/lib/components';
  import SubSidebar from '@theme/components/SubSidebar';
  import { useInstance } from '@theme/helpers/composable';
  import { $route } from 'vue-demi';
