      ...
      <div>
        <ModuleTransition>
          <img
            ...
            alt="hero"
          />
          <!-- <bubblesEffect :options="bubblesOptions"></bubblesEffect> -->
        </ModuleTransition>

        <!-- <ModuleTransition delay="0.00"> -->
        <!-- <h1 id="typed" v-if="recoShowModule && $frontmatter.heroText !== null">
  ...
  export default defineComponent({
    ...
    setup(props, ctx) {
      ...
      const bubblesOptions = {
        color: 'rgba(225,225,225,0.6)', //Bubble color
      ...
      onMounted(() => {
        ...
        let options = {
          strings: ['朝罢从容归陋院,喜看旭日散晴辉'],
          typeSpeed: 200,
          loop: false
        };
        new Typed('#word', options);
      });
